...
function HeroSection({ token, userType}) {
    const offersLink = token && userType === 'customer'? '/Auth/Customer/ViewOffers': '/login';
    const pollLink = token && userType === 'customer'? '/Auth/Customer/ParticipatePolls': '/login';
    return (
        <section className="w-full bg-blue-600 text-white py-16">
            <div className="container mx-auto px-4 text-center">
                ...
                <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4">
                    <Link to={offersLink} className="btn btn-primary text-white bg-blue-700 hover:bg-blue-800 focus:ring-blue-500">
                        View Offers
                    </Link>
                    ...
                    <Link to={pollLink} className="btn btn-accent text-white bg-purple-700 hover:bg-purple-800 focus:ring-purple-500">
